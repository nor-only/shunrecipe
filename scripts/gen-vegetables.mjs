...
const data = [
  ...
  { slug: 'takenoko', name_ja: 'たけのこ', name_en: 'Bamboo Shoot', aliases: ['竹の子','タケノコ'],
    ...
    related: ['r_takenoko','r_takenoko_isobe','r_takenoko_kinpira'], image: '/assets/images/takenoko_rice.png',
  ...
  { slug: 'cabbage', name_ja: '新キャベツ', name_en: 'Spring Cabbage', aliases: ['春キャベツ'],
    ...
    related: ['r_cabbage_clam','r_cabbage_roll','r_cabbage_peperoncino'], image: '/assets/images/cabbage_clam.png',
  ...
  { slug: 'asparagus', name_ja: 'アスパラガス', name_en: 'Asparagus', aliases: ['グリーンアスパラ'],
    ...
    related: ['r_asparagus_cheese','r_asparagus_soup','r_asparagus_bacon'], image: '/assets/images/asparagus_cheese.png',
  ...
  { slug: 'nanohana', name_ja: '菜の花', name_en: 'Rapeseed Blossoms', aliases: ['なのはな'],
    ...
    related: ['r_nanohana_karashi','r_nanohana_pasta','r_nanohana_tamagotoji'], image: '/assets/images/nanohana_karashi.png',
  ...
  { slug: 'shin_tamanegi', name_ja: '新たまねぎ', name_en: 'New Onion', aliases: ['新玉ねぎ','新玉'],
    ...
    related: ['r_shin_tamanegi_soup','r_shin_tamanegi_salad','r_shin_tamanegi_sukiyaki'], image: '/assets/images/shin_tamanegi_soup.png',
  ...
  { slug: 'tomato', name_ja: 'トマト', name_en: 'Tomato', aliases: [],
    ...
    related: ['r_tomato','r_tomato_caprese','r_tomato_curry'], image: '/assets/images/tomato_caprese.png',
  ...
  { slug: 'cucumber', name_ja: 'きゅうり', name_en: 'Cucumber', aliases: [],
    ...
    related: ['r_cucumber_salad','r_cucumber_sunomono','r_cucumber_pork_fry'], image: '/assets/images/cucumber_salad.png',
  ...
  { slug: 'nasu', name_ja: 'なす', name_en: 'Eggplant', aliases: ['茄子'],
    ...
    related: ['r_nasu_miso','r_nasu_agebitashi','r_ratatouille'], image: '/assets/images/nasu_miso.png',
  ...
  { slug: 'corn', name_ja: 'とうもろこし', name_en: 'Corn', aliases: ['スイートコーン'],
    ...
    related: ['r_corn_rice','r_corn_soup','r_corn_kakiage'], image: '/assets/images/corn_rice.png',
  ...
  { slug: 'edamame', name_ja: '枝豆', name_en: 'Edamame', aliases: [],
    ...
    related: ['r_edamame_rice','r_edamame_garlic','r_edamame_salad'], image: '/assets/images/edamame_rice.png',
  ...
  { slug: 'satsumaimo', name_ja: 'さつまいも', name_en: 'Sweet Potato', aliases: [],
    ...
    related: ['r_satsumaimo_gratin','r_satsumaimo_lemon'], image: '/assets/images/satsumaimo_lemon.png',
  ...
  { slug: 'kabocha', name_ja: 'かぼちゃ', name_en: 'Japanese Pumpkin', aliases: ['南瓜'],
    ...
    related: ['r_kabocha_salad','r_kabocha_pudding','r_pumpkin'], image: '/assets/images/kabocha_salad.png',
  ...
  { slug: 'kinoko', name_ja: 'きのこ類', name_en: 'Mushrooms', aliases: ['しいたけ','舞茸','しめじ'],
    ...
    related: ['r_kinoko_ahijo','r_mushroom_pasta','r_kinoko_gratin'], image: '/assets/images/kinoko_ahijo.png',
  ...
  { slug: 'renkon', name_ja: 'れんこん', name_en: 'Lotus Root', aliases: ['蓮根'],
    ...
    related: ['r_renkon_kinpira','r_renkon_chikuwa','r_renkon_salad'], image: '/assets/images/renkon_kinpira.png',
  ...
  { slug: 'satoimo', name_ja: '里芋', name_en: 'Taro', aliases: [],
    ...
    related: ['r_satoimo_soboro','r_satoimo_croquette','r_satoimo_gratin'], image: '/assets/images/satoimo_soboro.png',
  ...
  { slug: 'daikon', name_ja: '大根', name_en: 'Daikon Radish', aliases: [],
    ...
    related: ['r_daikon','r_daikon_furofuki','r_daikon_scallop_salad'], image: '/assets/images/daikon_furofuki.png',
  ...
  { slug: 'hakusai', name_ja: '白菜', name_en: 'Napa Cabbage', aliases: [],
    ...
    related: ['r_hakusai_cream','r_hakusai_mapo','r_millefeuille_nabe'], image: '/assets/images/millefeuille_nabe.png',
  ...
  { slug: 'hourensou', name_ja: 'ほうれん草', name_en: 'Spinach', aliases: [],
    ...
    related: ['r_hourensou_gomaae','r_hourensou_bacon','r_hourensou_quiche'], image: '/assets/images/hourensou_gomaae.png',
  ...
  { slug: 'broccoli', name_ja: 'ブロッコリー', name_en: 'Broccoli', aliases: [],
    ...
    related: ['r_broccoli_salad','r_broccoli_meat_fry','r_broccoli_shrimp'], image: '/assets/images/broccoli_salad.png',
  ...
  { slug: 'negi', name_ja: '長ねぎ', name_en: 'Japanese Leek', aliases: ['根深ねぎ'],
    ...
    related: ['r_negi_chicken_soup','r_negi_pork','r_negi_ahijo'], image: '/assets/images/negi_chicken_soup.png',
  ...
  { slug: 'shogoin_daikon', name_ja: '聖護院大根', name_en: 'Shogoin Daikon', aliases: [],
    ...
    storage: '新聞紙で包み冷暗所。',
    related: ['r_daikon_furofuki'], image: '',
